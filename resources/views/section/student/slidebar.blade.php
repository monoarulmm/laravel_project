<div class="deznav">
	<div class="deznav-scroll">
		<ul class="metismenu" id="menu">
			...
			<li><a class="ai-icon" href="{{route('student.suggestion',$user->id)}}" aria-expanded="false">
					<i class="la la-calendar"></i>
					<span class="nav-text">Suggestion</span>
				</a>
			
			</li>
			<li><a class="has-arrow" href="{{route('student.notice',$user->id)}}" aria-expanded="false">
